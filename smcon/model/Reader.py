...
class Reader:
    ...
    def __init__(self, contract_address, maxCount) -> None:
        ...
        self.contractName, self.storageLayout, self.abi, self.transactions = bdProvider.read()
        self.txCursor = 0 
    ...
    def iterateTx(self):
        ...
        for trace in self.transactions[self.txCursor]:
                ...
                if trace["action"]["from"].lower()!="0x0" \
                    ...
                    envs.append(dict(name ="msg.gas", value = trace["action"]["gas"]))
        ...
        return isFirstTx, tx_hash, funcNames, envs, stateDiff

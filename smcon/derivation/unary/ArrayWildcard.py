...
from smcon.model.model import VariableModel, StructVariableModel, ArrayVariableModel, VarType
...
class ArrayWildcard(Derivation):
    ...
    def _valid_vars(cls, vars: List[VarInfo]) -> bool:
        ...
        return len(vars) == 1 and vars[0].isStateVar() \
            ...
            and vars[0].type in ["uint"+str(i*8) for i in range(1, 33)]+["int"+str(i*8) for i in range(1, 33)]

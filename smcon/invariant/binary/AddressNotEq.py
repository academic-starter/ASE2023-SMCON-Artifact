from smcon.invariant.binary.AddressBinary import AddressBinary
from smcon.const import INVARIANT_STYLE
class AddressNotEq(AddressBinary):
    ...
    def __str__(self) -> str:
        if INVARIANT_STYLE == "VERISOL":
            ...
            desc = "AddressNotEq({0}, {1})".format(self.varInfos[0].name, self.varInfos[1].name)
            return desc